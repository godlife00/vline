...
$(document).ready(function () {
    ...
    if ($('#containeroutline1_2_M3').length) {
            ...
            series: [
                {
                    ...
                    tooltip: {
                        ...
                        pointFormat: '<b>시가 : {point.open}<br/>고가 : {point.high}<br/>저가 : {point.low}<br/></b>',
                    },
                    zIndex: 1
                },
                {
        ...
        chart_M3.series[1].setData(chart_value5); // 주가 선차트
        ...
        chart_M6.series[1].setData(chart_value5); // 주가 선차트
...
// 기업개요 주가차트
function viewDetailStockChart(obj_id, value, value5) {
	...
	$(function() {
		var sumchart = new Highcharts.stockChart(obj_id, {
			chart: {
				// borderColor: '#333',                
			},
